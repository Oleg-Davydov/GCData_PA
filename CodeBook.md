...
<p style="margin-left:27px;">IDs for 30 volunteers of the Human Activity Recognition Using Smartphones experiment.</p>

<p style="margin-left:54px;">1..30 Unique identifier assigned to every volunteer.</p>
...
<p style="margin-left:27px;">Average values of all variables computed for each activity and each subject.</p>

<p style="margin-left:54px;">-0.9976661..0.9745087</p>
